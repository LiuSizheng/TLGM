...
clear;
net=load('LFR2000-k15.txt'); %读取网络文件test0425
...
average_i=sir_main(adjMat,1000,0.058) ;%传播概率 每个节点的平均感染数0.047

save('LFR2000-k15.mat', 'd', 'h','p','MDD_core','kcore','neighbor_Core','GAC','KSGC','average_i');
%save('LFR2000-k15.mat', 'd', 'h','p','MDD_core','kcore','neighbor_Core','GAC','KSGC');
% average_iall={};
