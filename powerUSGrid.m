...
average_i=sir_main(adjMat,1000,0.258) ;%传播概率 每个节点的平均感染数0.047

save('power-US-Grid.mat', 'd', 'h','p','MDD_core','kcore','neighbor_Core','KSGC','GAC','DC_stc','average_i');
...
for i = 1:15
    ...
    disp(i);
    average_iall{i} = sir_main(adjMat, 1000, 0.01*i+0.18);%0.19-0.33
end
...
save('power-US-Grid_sir19_33_Kendall.mat', 'average_iall','a00_degree', 'a00_h_index','a00_pagerank','a00_MDD_core','a00_GAC','a00_kcore','a00_neighbor_core','a00_KSGC','a00_TLGM');
