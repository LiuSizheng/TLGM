clear;% 清除工作区变量
dataset_name = 'USAir97';  % 加载数据集并处理成邻接矩阵examplenetwork
...
average_i=sir_main(adjMat,1000,0.023) ;%传播概率 每个节点的平均感染数0.047

save('USAir97.mat', 'd', 'h','p','MDD_core','kcore','neighbor_Core','KSGC','GAC','DC_stc','average_i');
...
save('USAir97_sir1_15_Kendall.mat', 'average_iall','a00_degree', 'a00_h_index','a00_pagerank','a00_MDD_core','a00_GAC','a00_kcore','a00_neighbor_core','a00_KSGC','a00_TLGM');
