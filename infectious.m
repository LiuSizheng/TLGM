...
clear;
net=load('infectious.txt'); %读取网络文件test0425
...
average_i=sir_main(adjMat,1000,0.053) ;%传播概率 每个节点的平均感染数0.047

save('infectious.mat', 'd', 'h','p','MDD_core','kcore','neighbor_Core','GAC','KSGC','average_i');
...
save('infectious_sir1_15_Kendall.mat', 'a00_degree', 'a00_h_index','a00_pagerank','a00_MDD_core','a00_GAC','a00_kcore','a00_neighbor_core','a00_KSGC');
