...
average_i_0_047=sir_main(adjMat,1000,0.047) ;%传播概率 每个节点的平均感染数0.047
load('facebook324.mat');
save('facebook324.mat','average_i_0_047', '-append');
%save('facebook324.mat', 'd', 'h','p','MDD_core','kcore','neighbor_Core','GAC','KSGC','average_i');
% 
% 
% 
% 
...
% end
% 
% save('facebook324_sir1_15_Kendall.mat', 'a00_degree', 'a00_h_index','a00_pagerank','a00_MDD_core','a00_GAC','a00_kcore','a00_neighbor_core','a00_KSGC');
% 
% 
% 
% 
