clear;
% 加载之前保存的数组yeast1458 facebook324 protain netscience infectious 
% CA-GrQc 1LFR2000-k5 LFR2000-10 LFR2000-k15
load('CA-GrQc.mat');
%'d', 'h','p','MDD_core','kcore','neighbor_Core','GAC','KSGC','average_i'
% 现在可以使用数组x和y了
%% 创建散点图
figure; % 创建一个新的图形窗口
scatter(neighbor_EKC,average_i, 'r+'); 
xlabel('Neighbor EKC');%neighbor_EKC extend_neighbor_EKC EKC_values
ylabel('Φ', 'Rotation', 0);
% 
% figure; % 创建一个新的图形窗口
...
load('facebook324_sir1_15_Kendall.mat');
